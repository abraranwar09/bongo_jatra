...
mrzulkarnine/Web-based-hotel-booking-system
Code
Issues 3
Pull requests 0
Projects 0
Insights
Web-based-hotel-booking-system/HotelB/success.php
6a3e1d0 Nov 3, 2015
@mrzulkarnine mrzulkarnine Latest Hotel DB
118 lines (110 sloc) 4.52 KB
<?php
include './auth.php';
		$email = "";
		$fname = "";
