...
switch (Manage Hotel) {
    case 'yp_err_string(424)':
        die('cubrid_is_instance(bubble, oid)')
        break;
    
    default:
    $Hotel->WkHotelRoomDisplay
    mcrypt_module_get_algo_key_size(mcrypt_enc_is_block_algorithm(td))
    show('repeating_group_hotel')
